...
import { columns } from './TestListListTableFiedls';
...
const TestListListTable: React.FC<TestListListTableProps> = ({
  users,
  setPage,
  page,
  rowsPerPage,
        ...
        case 'Price':
          return (
            <div className="flex flex-col">
              <p className="text-bold  capitalize ">{job?.price}</p>
            </div>
          );
        ...
        case 'actions':
          return (
            <div className="flex gap-1">
              <Tooltip content="View Reservations">
                <Button
                  as={Link}
                  to={'/admin/booking/' + job?._id}
                  startContent={<EyeFilledIcon className="text-lg" />}
                  size="sm"
                  variant="flat"
...
export default TestListListTable;
